...
from model_VAE_new2 import simplified_manifold_loss
...
class Net(nn.Module):
    ...
    def forward(self, x_list, mapped_fea, mask):
        ...
        z_sample, uniview_mu_list, uniview_sca_list, fusion_z_mu, fusion_z_sca, xr_list, xr_p_list, cos_loss, fea_p_list = self.VAE(x_list,mapped_fea,mask=None)  #Z[i]=[128, 260, 512] b c d_e
        ...
        return z_sample, uniview_mu_list, uniview_sca_list, fusion_z_mu, fusion_z_sca, xr_list, label_embedding_sample, p, xr_p_list, cos_loss, loss_manifold_p_avg
